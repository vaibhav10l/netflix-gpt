...
import { toggleGPTSearch } from '../utils/store/slice/gptSlice';
...
const Header = () => {
  ...
  return (
    <div className='absolute w-screen px-2 bg-gradient-to-b from-black z-20 flex justify-between'>
      ...
      {!!user && (
        <div className='p-2'>
          <select className='text-sm px-3 py-2.5 text-center me-2 mb-2 bg-blue-300 rounded-lg' onChange={handleOnLangChange}> 
